...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#D4A017] via-[#C68E17] to-[#B8860B] text-white relative overflow-hidden">
      <Particles />
      
      {/* Navigation */}
      <nav 
        className={`fixed w-full z-50 bg-[#FFD700]/10 backdrop-blur-sm ${
          showSidebar ? 'translate-y-0' : '-translate-y-full'
        } ${window.scrollY < (document.getElementById('home')?.offsetHeight || 0) ? '' : 'transition-transform duration-300'}`}
        ...
        <div className="container mx-auto px-4 py-2">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className={`${mobileMenuOpen ? 'block' : 'hidden'} md:flex md:items-center md:space-x-8 mt-4 md:mt-0`}>
              <a href="#home" className="block py-2 hover:text-yellow-300 transition-colors">Home</a>
              <a href="#skills" className="block py-2 hover:text-yellow-300 transition-colors">Skills</a>
              <a href="#projects" className="block py-2 hover:text-yellow-300 transition-colors">Projects</a>
              <a href="#portfolio-description" className="block py-2 hover:text-yellow-300 transition-colors">About</a>
              <div className="flex items-center space-x-4 mt-4 md:mt-0">
                ...
                <a href="#contact" className="honey-button px-6 py-2 bg-[#1A1A1A] text-[#FFD700] rounded-full hover:opacity-90 transition-opacity">
                  Let's Connect
                </a>
              </div>
            </div>
      ...
      <SmoothScroll>
        ...
        <section id="home" className="min-h-screen pt-20 relative overflow-hidden">
          <div className="container mx-auto px-4 py-12 md:py-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
              <div>
                <div className="inline-block px-4 py-2 bg-[#B8860B]/20 rounded-full mb-4 md:mb-6 text-sm md:text-base">
                  Welcome to my Portfolio
                </div>
                <h1 className="text-4xl md:text-6xl font-bold mb-4 md:mb-6 text-[#1A1A1A] space-y-2 md:space-y-4">
                  <div>
                ...
                <div className="text-[#1A1A1A] mb-6 md:mb-8 space-y-1 md:space-y-2">
                ...
                <a href="#contact" className="honey-button group relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-[#1A1A1A] rounded-lg shadow-2xl text-sm md:text-base">
                  <span className="absolute inset-0 w-full h-full transition duration-300 ease-out opacity-100 bg-gradient-to-br from-[#FFD700] via-[#FFA500] to-[#FF8C00] group-hover:opacity-0"></span>
                  <span className="absolute inset-0 w-full h-full transition duration-300 ease-out opacity-0 bg-gradient-to-br from-[#FF8C00] via-[#FFA500] to-[#FFD700] group-hover:opacity-100"></span>
        ...
        {/* Skills Section */}
        <section id="skills" className="py-16 md:py-20 bg-gradient-to-b from-[#B8860B] to-[#D4A017]">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
              <SkillCircle skill="C/C++" percentage={95} />
              <SkillCircle skill="Web Development" percentage={85} />
              <SkillCircle skill="Data Analysis" percentage={80} />
              <SkillCircle skill="Cyber Security" percentage={75} />
            </div>
          </div>
        </section>
        ...
        <section id="portfolio-description" className="py-16 md:py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 md:p-8 text-white">
        ...
        <section id="contact" className="py-16 md:py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <div className="bg-[#FFD700]/30 p-6 md:p-8 rounded-2xl backdrop-blur-sm">
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                    <input type="text" name="firstName" placeholder="First Name" required className="w-full px-4 py-3 rounded-lg bg-yellow-900/50 border border-yellow-700 focus:outline-none focus:border-yellow-500"/>
                    <input type="text" name="lastName" placeholder="Last Name" required className="w-full px-4 py-3 rounded-lg bg-yellow-900/50 border border-yellow-700 focus:outline-none focus:border-yellow-500"/>
                  </div>
                  <input type="email" name="email" placeholder="Email Address" required className="w-full px-4 py-3 rounded-lg bg-yellow-900/50 border border-yellow-700 focus:outline-none focus:border-yellow-500"/>
                  <input type="tel" name="phone" placeholder="Phone No." className="w-full px-4 py-3 rounded-lg bg-yellow-900/50 border border-yellow-700 focus:outline-none focus:border-yellow-500"/>
                  <textarea name="message" placeholder="Message" rows={4} required className="w-full px-4 py-3 rounded-lg bg-yellow-900/50 border border-yellow-700 focus:outline-none focus:border-yellow-500"/>
                  <button 
                    type="submit" 
                    className="honey-button w-full px-6 py-3 bg-[#1A1A1A] text-[#FFD700] rounded-lg font-semibold hover:opacity-90 transition-colors disabled:opacity-50"
