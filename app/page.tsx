  ...
  export default function Home() {
    ...
    return (
      <main className={`min-h-screen ${
        ...
        <Particles isSnowTheme={isSnowTheme} />
          ...
          <div className="container mx-auto px-4 py-2">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              ...
              <div className={`${mobileMenuOpen ? 'block' : 'hidden'} md:flex md:items-center md:space-x-8 mt-4 md:mt-0`}>
                <a href="#home" className={`block py-2 ${isSnowTheme ? 'hover:text-blue-300' : 'hover:text-yellow-300'} transition-colors`}>Home</a>
                <a href="#skills" className={`block py-2 ${isSnowTheme ? 'hover:text-blue-300' : 'hover:text-yellow-300'} transition-colors`}>Skills</a>
                <a href="#projects" className={`block py-2 ${isSnowTheme ? 'hover:text-blue-300' : 'hover:text-yellow-300'} transition-colors`}>Projects</a>
                <a href="#portfolio-description" className={`block py-2 ${isSnowTheme ? 'hover:text-blue-300' : 'hover:text-yellow-300'} transition-colors`}>About</a>
                <div className="flex items-center space-x-4 mt-4 md:mt-0">
                  <a href="#" className={`${isSnowTheme ? 'hover:text-blue-300' : 'hover:text-yellow-300'} transition-colors`}>
                  ...
                  <ThemeToggle isSnowTheme={isSnowTheme} toggleTheme={toggleTheme} />
                  <a 
                    href="#contact" 
        ...
        <SmoothScroll>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                <div>
                  <div className={`inline-block px-4 py-2 rounded-full mb-4 md:mb-6 text-sm md:text-base ${
                    isSnowTheme ? 'bg-blue-500/20' : 'bg-[#B8860B]/20'
                  }`}>
                  ...
                  <a 
                    href="#contact" 
                    className={`group relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-[#1A1A1A] rounded-lg shadow-2xl text-sm md:text-base ${
                      isSnowTheme
                        ? 'bg-blue-500 hover:bg-blue-600'
                        : 'bg-gradient-to-br from-[#FFD700] via-[#FFA500] to-[#FF8C00] hover:bg-gradient-to-br hover:from-[#FF8C00] hover:via-[#FFA500] hover:to-[#FFD700]'
                    }`}
                  >
                ...
                <div className="relative flex items-center justify-center mt-8 md:mt-0">
                  {isSnowTheme ? <SnowmanCharacter /> : <BeeCharacter />}
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="skills" className={`py-16 md:py-20 ${
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
                <SkillCircle skill="C/C++" percentage={95} isSnowTheme={isSnowTheme} />
                <SkillCircle skill="Web Development" percentage={85} isSnowTheme={isSnowTheme} />
                <SkillCircle skill="Data Analysis" percentage={80} isSnowTheme={isSnowTheme} />
                <SkillCircle skill="Cyber Security" percentage={75} isSnowTheme={isSnowTheme} />
              </div>
            </div>
          </section>
          ...
          <section id="portfolio-description" className="py-16 md:py-20">
            <div className="container mx-auto px-4">
              ...
              <div className={`${
                isSnowTheme ? 'bg-blue-200/10' : 'bg-white/10'
            ...
            <div className="container mx-auto px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                <div className="flex justify-center items-center">
                  <HoneyPotWithBee isSnowTheme={isSnowTheme} />
                </div>
                <div className={`${
                  isSnowTheme ? 'bg-blue-200/30' : 'bg-[#FFD700]/30'
